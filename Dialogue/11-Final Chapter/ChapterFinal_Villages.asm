...
.text	"O Black Knight Hezul, Mystletainn"
	.byte NewLine
.text	"the demonic in hand, smite the devil"
	.byte WaitForA
	.byte ScrollText

.text	"O Sword Saint Odo, Balmung"
	.byte NewLine
.text	"the divine in hand, repel the blight"
	.byte WaitForA
	.byte ScrollText

.text	"O Holy Knight Baldur, Tyrfing"
	.byte NewLine
